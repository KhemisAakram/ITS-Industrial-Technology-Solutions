...
### 🟢 Low priority
- [ ] Courses every day — 45 min SOMIK + 45 min VFD (+ PCB swaps in for the weakest) → [[10_Courses]]
...
- [ ] SOMIK: trial cuts + calibration
- [ ] Final report: writing chapters (Ch 1–3)
- [ ] Final report: editing + review passes
- [ ] Defense slides design
...
- [ ] Client job execution (existing clients)
- [ ] Workshop: bench + tool layout
- [ ] Workshop: electrical installation (sockets, lighting)
- [ ] Soldering / PCB work
...
- [ ] Bookkeeping / invoice prep
- [ ] Buy parts list / procurement notes
- [ ] Organize photos (before/after jobs)
- [ ] Tool cleanup + inventory
- [ ] Daily note + weekly review writing
- [ ] Phone calls / appointment setting

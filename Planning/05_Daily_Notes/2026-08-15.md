...
> Focus: 5-day sprint day 3/5 — injection machine + meat mixer part
...
- [ ] **Block 1 [HIGH]:** FLOWAXS injection machine — spec + parts -> [[Flowaxs]]
- [ ] **Block 2 [HIGH]:** Design Print Part 2 — meat mixer replacement part -> [[Client_Jobs]]
- [ ] SOMIK course 45 min -> [[10_Courses]]

## Before noon (steady work)
- [ ] **Block 3 [MEDIUM]:** FLOWAXS — design + layout -> [[Flowaxs]]
...
- [ ] Sprint day 3/5: injection machine started · meat mixer part designed + printed
